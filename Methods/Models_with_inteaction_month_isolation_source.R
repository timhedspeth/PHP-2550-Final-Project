# This code will be the primary script in terms of modeling with for our
...
# It seems natural that the source and the month may interact, given that SNP may not 
# be the 
...
salmonella_train$score <- as.numeric(salmonella_train[,11])
...
ecoli_train$score <- as.numeric(ecoli_train[,10])
