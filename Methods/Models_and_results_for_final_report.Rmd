...
sal_coefs_table %>%  kbl(caption = "Table 3: Score coefficents for Salmonella Risk model",
...
```{r, fig.cap= "Figure 4: Classification Tree for Salmonella"}
...
salmonella_test  %>% group_by(score) %>% 
                     ...
                     kbl(caption = "Table 6: Salmoella test set",
                         booktabs=T, escape=T, align = "c") %>%
                     kable_styling(full_width = FALSE, latex_options = c('hold_position'))
...
salmonella_train %>% group_by(score) %>% 
                     dplyr::summarize(pct = 100*round(sum(outbreak_1)/n(),4)) %>% 
                     dplyr::rename("Percent outbreaks" = pct) %>% 
                     kbl(caption = "Table 7: Salmonella training data",
                         booktabs=T, escape=T, align = "c") %>%
                     kable_styling(full_width = FALSE, latex_options = c('hold_position'))
...
# Make sure all the factors are interpetable 
...
eco_coefs_table %>%  kbl(caption = "Table 4: Score coefficents for E. coli Risk model",booktabs=T, escape=T, align = "c") %>%
                     kable_styling(full_width = FALSE, latex_options = c('hold_position'))
...
```{r, fig.cap= "Figure 5: Classification Tree for E. Coli" }
...
ecoli_test %>% group_by(score) %>% 
                     dplyr::summarize(pct = 100*round(sum(outbreak_1)/n(),4)) %>% 
                     dplyr::rename("Percent outbreaks" = pct) %>% 
                     kbl(caption = "Table 8: E. coli test set",
                         booktabs=T, escape=T, align = "c") %>%
                     kable_styling(full_width = FALSE, latex_options = c('hold_position'))
...
ecoli_train  %>% group_by(score) %>% 
                     dplyr::summarize(pct = 100*round(sum(outbreak_1)/n(),4)) %>% 
                     dplyr::rename("Percent outbreaks" = pct) %>% 
                     kbl(caption = "Table 9: E. coli training data",
                         booktabs=T, escape=T, align = "c") %>%
                     kable_styling(full_width = FALSE, latex_options = c('hold_position'))
...
metrics %>% kbl(caption = "Table 5: Metrics for models on testing data",
                         booktabs=T, escape=T, align = "c") %>%
                     kable_styling(full_width = FALSE, latex_options = c('hold_position'))
